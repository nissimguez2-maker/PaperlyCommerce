...
/** Sticky floating WhatsApp button — on every page EXCEPT cart/checkout. */
export function WhatsAppButton() {
  ...
  return (
    <a
      href={whatsappLink(t('waFloating'))}
      target="_blank"
